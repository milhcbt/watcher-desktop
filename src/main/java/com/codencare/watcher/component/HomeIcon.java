 ...
 *         Time: 07:45
 */
public class HomeIcon extends StackPane {
   ...
   */
  public HomeIcon(String text, Node graphic, final ImageView notifyImage) {
   ...
   */
  public HomeIcon(String text, Node graphic, final ImageView notifyImage, final AnimationType type) {
