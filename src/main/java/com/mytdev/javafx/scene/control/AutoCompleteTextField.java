...
public class AutoCompleteTextField<T> extends Control {
    ...
    protected String getUserAgentStylesheet() {
        return MainApp.defaultProps.getProperty("CSS");
//        return "com/mytdev/javafx/internal/scene/control/" + this.getClass().getSimpleName() + ".css";
//          return "styles/Styles.css";
     ...
     */
    public static interface DataToString<T> {
         ...
         */
        String toString(T item, AutoCompleteTextField<T> ctl);
    }
    ...
    public static final class DefaultDataToString<T> implements DataToString<T> {
        @Override
        public String toString(T item,AutoCompleteTextField<T> ctl) {
            ctl.setSelectedData(item);
    ...
    private void setSelectedData(T selectedData) {
